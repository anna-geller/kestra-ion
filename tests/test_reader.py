...
def test_iso_8601_parsing(load_ion_data):
    ...
    print(result)  # Debugging output
    # Test first record
    assert result[0]["iso_8601_column"] == datetime(2023, 12, 31, 23, 59, 59, tzinfo=timezone.utc)
    ...
    expected_date = datetime(2023, 10, 4, 15, 30, 0, 123456, tzinfo=timezone(timedelta(hours=2)))
